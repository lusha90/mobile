...
public class DZHIosInfo {
    ...
    private List<IosDeviceInfo> devicesInfo;
    ...
    public List<IosDeviceInfo> getDevicesInfo() {
        return devicesInfo;
    }

    public void setDevicesInfo(List<IosDeviceInfo> devicesInfo) {
