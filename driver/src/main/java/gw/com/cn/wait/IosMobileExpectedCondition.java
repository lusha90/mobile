 ...
 * element is visible.
 * <p>
 * Note that it is expected that IosMobileExpectedCondition are idempotent. They will be called in a loop by
 * the {@link WebDriverWait} and any modification of the state of the application under test may
 * have unexpected side-effects.
 *
 * @param <T> The return type
 */
public interface IosMobileExpectedCondition<T> extends Function<IOSDriver, T> {}
